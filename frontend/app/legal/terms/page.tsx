        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              En accédant et en utilisant Maintenance.com.tn, vous acceptez de respecter
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-4">
              Maintenance.com.tn ne sera pas responsable de tout dommage indirect,
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              à info@maintenance.tn ou +216 XX XXX XXX.
            </p>
          </section>
        </div>
      </div>
