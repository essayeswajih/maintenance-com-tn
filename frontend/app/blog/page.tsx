...
export default function BlogPage() {
  ...
  const articles = [
    ...
    {
      id: 5,
      title: 'Guide complet: dépannage de fuite d\'eau',
      slug: 'depannage-fuite',
      excerpt: 'Comment identifier et résoudre rapidement une fuite d\'eau dans votre maison.',
      date: '10 Jan 2024',
      author: 'Fatima Ben',
      category: 'Plomberie',
      image: '💧',
    ...
    {
      id: 6,
      title: 'Sécurité électrique: les équipements essentiels',
      slug: 'securite-electricite',
      excerpt: 'Les dispositifs de sécurité indispensables pour protéger votre installation électrique.',
      date: '8 Jan 2024',
      author: 'Mohamed Ali',
      category: 'Électricité',
      image: '🔌',
  ...
  const categories = [
    { name: 'Tous', count: 18 },
    { name: 'Plomberie', count: 6 },
    { name: 'Électricité', count: 5 },
    { name: 'Chauffage', count: 4 },
    { name: 'Chaudières', count: 3 },
  ]
