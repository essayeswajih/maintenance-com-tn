...
def create_category(category_in: CategoryServiceCreate, db: Session = Depends(get_db)):
...
def update_category(category_id: int, category_in: CategoryServiceUpdate, db: Session = Depends(get_db)):
